...
import top.janker.jmall.admin.model.param.UmsAdminLoginParam;
...
public class UmsAdminController {
    ...
    @Value("${micro.security.tokenHead}")
    ...
    @ResponseBody
    public CommonResult<UmsAdmin> getItem(@PathVariable Integer id) {
