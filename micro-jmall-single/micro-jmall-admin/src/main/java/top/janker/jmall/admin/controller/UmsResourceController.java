...
import top.janker.micro.common.security.component.DynamicSecurityMetadataSource;
 ...
 */
@Controller
@Api(tags = "后台资源管理接口", description = "后台资源管理")
...
public class UmsResourceController {
    ...
    @ResponseBody
    public CommonResult<UmsResource> getItem(@PathVariable Integer id) {
